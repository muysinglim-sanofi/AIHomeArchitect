...
for _d in [
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["pale ash or birch floor", "wabi-sabi plaster walls", "natural linen bedding in stone or fog tones"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["honed natural stone floor", "wabi-sabi plaster walls", "matte black or graphite fixtures"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["pale ash floor", "wabi-sabi plaster walls", "natural linen chair upholstery or bare ash seat"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["large-format honed stone floor", "wabi-sabi plaster walls", "matte black or ash door hardware"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["pale ash floor", "wabi-sabi plaster walls", "matte black desk accessories"],
