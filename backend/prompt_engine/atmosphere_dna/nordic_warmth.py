...
for _d in [
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["pine or birch floor", "warm white plaster walls", "layered natural linen and wool bedding"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["pine floor", "warm white plaster walls", "natural linen or wool chair upholstery"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["pine or stone floor", "warm white plaster walls", "white-painted pine joinery"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["pine floor", "warm white plaster walls", "natural linen or wool upholstery"],
