...
_SIGNAL_BONUSES: list[tuple[str, str, float]] = [
    ...
    ("high ceiling",     "dark_contemporary", 0.10),
    ...
    ("city view",        "dark_contemporary", 0.08),
    ("urban",            "dark_contemporary", 0.08),
