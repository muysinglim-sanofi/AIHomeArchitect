...
final featuredShowcase = [
  ProjectModel(
    id: 'featured_1',
    title: 'Living Room — Warm Modern',
    roomType: 'Living Room',
    style: 'Warm Modern',
    beforeImageUrl: 'assets/showcase/living_before.jpg',
    afterImageUrl: 'assets/showcase/living_after.jpg',
  ...
  ProjectModel(
    id: 'featured_3',
    title: 'Bathroom — Soft Luxury',
    roomType: 'Bathroom',
    style: 'Soft Luxury',
    beforeImageUrl: 'assets/showcase/bathroom_before.jpg',
    afterImageUrl: 'assets/showcase/bathroom_after.jpg',
    status: ProjectStatus.completed,
