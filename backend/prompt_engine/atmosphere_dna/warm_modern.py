...
for _d in [
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["European oak floor", "warm plaster walls", "travertine or warm stone table top"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["large-format travertine or limestone floor", "warm plaster walls", "brushed brass mirror frame"],
    ...
    RoomAdaptationDNA(
        ...
        material_palette=["European oak desk surface", "warm sand plaster walls", "warm linen upholstery"],
