...
const Map<String, String> frTranslations = {
  ...
  'promoRedeemTitle': "Utiliser un code",
  'promoRedeemSubtitle': "Saisissez votre code pour débloquer des générations.",
  'promoCodeHint': "Saisissez votre code",
  'promoApply': "Appliquer",
  'promoDone': "Terminé",
  'promoSuccessUnlimited': "Accès VIP activé.",
  'promoErrInvalidCode': "Code invalide. Vérifiez-le et réessayez.",
  'promoErrExpired': "Ce code a expiré.",
  'promoErrInactive': "Ce code n'est plus actif.",
  'promoErrAlready': "Vous avez déjà utilisé ce code.",
  'promoErrMaxRedemptions': "Ce code a atteint sa limite.",
  'promoErrRateLimited': "Trop de tentatives. Réessayez plus tard.",
  'promoErrNetwork': "Erreur réseau. Veuillez réessayer.",
  'promoErrGeneric': "Ce code n'a pas pu être appliqué.",
  ...
  // Admin — promo panel
  'admTitle': "Admin",
  'admPromoCodes': "Codes promo",
  'admGenerateCode': "Générer un code",
  'admType': "Type",
  'admTypeLimited': "Générations limitées",
  'admTypeUnlimited': "Illimité (VIP)",
  'admCustomCode': "Code personnalisé",
  'admCustomCodeHint': "Laissez vide pour générer automatiquement",
  'admGenerationLimit': "Générations",
  'admMaxRedemptions': "Utilisations max",
  'admExpiresAt': "Date d'expiration",
  'admExpiresNone': "Pas d'expiration",
  'admCampaign': "Campagne",
  'admNote': "Note",
  'admOptional': "optionnel",
  'admCreate': "Créer le code",
  'admCreating': "Création…",
  'admCodesTitle': "Codes",
  'admNoCodes': "Aucun code pour l'instant.",
  'admActive': "Actif",
  'admInactive': "Inactif",
  'admDisable': "Désactiver",
  'admEnable': "Activer",
  'admCopy': "Copier",
  'admCopied': "Copié",
  'admUnlimited': "Illimité",
  'admErrCreate': "Impossible de créer le code.",
  'admErrConflict': "Ce code existe déjà. Essayez-en un autre.",
  'admRedeemedLabel': "Utilisé",
  'promoSuccessLimited': "Code appliqué. Vous avez reçu {n} générations.",
