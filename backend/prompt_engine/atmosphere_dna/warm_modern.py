...
register_core(AtmosphereCoreDNA(
    ...
    luxury_level="Bright premium urban residence / contemporary warm home photographed in natural daylight",
...
for _d in [
    ...
    RoomAdaptationDNA(
        ...
        lighting_behavior="Warm daylight from windows + warm bedside table lamps as soft accent; bright inviting residential warmth, not dark hotel mood.",
    ...
    RoomAdaptationDNA(
        ...
        lighting_behavior="Bright warm daylight on worksurfaces + warm under-cabinet strip as soft accent; inviting daytime residential brightness.",
    ...
    RoomAdaptationDNA(
        ...
        lighting_behavior="Warm daylight from window over table + warm brass pendant as soft accent; bright inviting daytime dining warmth.",
